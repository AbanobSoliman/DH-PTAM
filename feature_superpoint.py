...
class SuperPointOptions:
    def __init__(self, do_cuda=True):
        ...
        self.weights_path = "./features/superpoint_v1.pth"
        self.nms_dist = 5
        self.conf_thresh = 0.000001
        self.nn_thresh = 3
        self.cell = 8  # Size of each output cell. Keep this fixed 8.
        self.border_remove = 4  # Remove points this close to the border 4.
...
class SuperPointFeature2D:
    def __init__(self, do_cuda=False):
        self.lock = RLock()
