...
def Dataset_loading():
    ...
    parser.add_argument("--dataset_type", default="tum")  # tum or vector or mvsec
    parser.add_argument("--dataset_name",
                        default="mocap-desk2")  # indoor_flying1, indoor_flying2, indoor_flying3, indoor_flying4, mocap-desk2   ,   mocap-6dof   ,   bike-easy   ,   floor2-dark , corner_slow1,  school_scooter1, corridors_walk1
    parser.add_argument("--scale", default=1, type=int)  # Motion: 1: Large    0: small
    ...
    return params, cam0_images, cam0_times, cam1_images, cam1_times, eventsL, eventsR, dt_ms, h, w, delta, xmap1, ymap1, xmap2, ymap2, xmap3, ymap3, xmap4, ymap4, Kc_L, Tce_L, Ke_L_inv, Kc_R, Tce_R, Ke_R_inv, cam, dvs, h_c, w_c, delta_uv_L, delta_uv_R, args
